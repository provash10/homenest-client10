...
const AddProperise = () => {
 ...
 <div className="min-h-screen flex items-center justify-center bg-gradient-to-br via-purple-300 to-pink-400">
  <form className="bg-white shadow-2xl rounded-2xl p-10 space-y-8 border border-gray-200 max-w-5xl w-full">
    ...
    <button
      type="submit"
      className="w-full bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white py-3 rounded-2xl text-lg font-semibold hover:scale-105 transform transition-all shadow-lg"
    >
      Add Property
    </button>
